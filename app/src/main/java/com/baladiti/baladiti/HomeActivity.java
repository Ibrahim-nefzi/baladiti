...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remember.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                //s'il clique sur remember me pour enregister les données
                ...
                //s'il ne clique pas sur remember me pour enregister les données
    ...
    //verifier le email et le mot de passe
    private void validate(String userName, String userPassword) {
        ...
        firebaseAuth.signInWithEmailAndPassword(userName, userPassword).addOnCompleteListener(task -> {
            //si les donnees sont vrai
            if (task.isSuccessful()) {
                progressDialog.dismiss();
                checkEmailVerification();
            }
            //si les donnees sont fausse
            else {
